...
const NavBar = () => {
    ...
    }, []) // ← missing dependency array would cause multiple re-renders
    ...
    return (
        <nav className={cn("fixed w-full z-40 transition-all duration-300", isScrolled ? "py-3 bg-background/80 backdrop-blur-md shadow-xs" : "py-5")}>
            <div className='container flex items-center justify-between'>
                ...
                <button onClick={()=>setIsMenuOpen((prev)=> !prev)} className='md:hidden text-foreground p-2 z-50' aria-label={isMenuOpen ?"Close Menu" : "Open Menu"}> 
